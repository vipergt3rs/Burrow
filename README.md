...
2. Open the Burrow app on your phone and tap **Scan for PC**, if scanning dosen't work manually type the **TCP address** from the terminal window of Burrow on the pc.
